/* This file is used to generate the SQLLexer.java file in 
 * "web-gui\src\main\java\net\sf\infrared\web\util\sql"  package.
 *  Any modifications made to this file takes effect only if the 
 *  same is used to generate the SQLLexer.java file using JFlex
 *  and the later placed in the appropriate package - viz 
 *  "web-gui\src\main\java\net\sf\infrared\web\util\sql".
 */
